  ...
  return (
    <div className="App">
      ...
      <header className="link-section">
        <nav>
          <a
            href="https://github.com/Bitcorn-labs"
            target="_blank"
      ...
      <div className="social-media-bar">
        <a
          href="https://twitter.com/icBITCORN"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://oc.app/community/btpel-lyaaa-aaaar-a4crq-cai"
          target="_blank"
          rel="noopener noreferrer"
          className="social-media-icon"
        >
      ...
      <div className="text-section">
        ...
        <p>
          Bitcorn is a peer-2-peer internet based group of Corn Farmers Offering
          innovative tools for the Interent Computer
        </p>
      </div>
      ...
      <div className="text-section">
        ...
        <p>
          ...
          from popular AMMS on the internet computer.{" "}
          <a
            href="https://suemn-5aaaa-aaaap-qb62q-cai.icp0.io/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          was introduced to produce tx URLs so tokens could be enabled on
          Openchat and other platforms that require a tx URL. This will allow
          users to query holders, and transactions because services like{" "}
          <a href="http://icscan.io/" target="_blank" rel="noopener noreferrer">
            icscan.io{" "}
          </a>
          and{" "}
          <a
            href="https://ic.house/ICP"
            target="_blank"
            rel="noopener noreferrer"
          >
            ic.house
      ...
      <div className="text-section">
        ...
        <ul>
          ...
          <li>
            🐓 (ICRC-1) (prev. DIP-20) (
            <a href="https://4pdas-zaaaa-aaaan-qdmxa-cai.ic0.app">STAKEHOUSE</a>
            ) (<a href="https://TENDY.ZONE/">TENDY ZONE</a>)
          </li>
          <li>
            🌽 (ICPI) (
            <a href="https://suemn-5aaaa-aaaap-qb62q-cai.icp0.io/">
          ...
          <li>
            ₿{" "}
            <a href="https://vomxe-siaaa-aaaas-aidqq-cai.icp0.io/">
              BoB reHasher
            </a>
          </li>
          <li>
